...
function escolherQuadrado( id ){
  ...
  if (quadrado.innerHTML !== '-'){
      return ; // Quadrado já preenchido por um jogador
  }
  quadrado.innerHTML = jogador;
  quadrado.style.color = '#000';
  // verifica quem é o jogador da vez e muda o jogador da vez
  if (jogador ==='X') {
      jogador = 'O' ;
...
function checkCampeao(){
    var arrayQuadrados = [] ;
    for (i=1; i <= 9; i++){
        arrayQuadrados[i] = document.getElementById(i) ;
    }
